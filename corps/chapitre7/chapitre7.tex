...
Une fois lancé, vous visualiserez les \RefGlossaire{Système}{Driver}{Pilote}{pilotes} \RefGlossaire{Philosophie}{-}{Logiciel Propriétaire}{propriétaires} -- correspondant à votre matériel -- et pourrez sélectionner ceux à installer et, enfin, cliquez sur «~Activate~». Renseignez votre mot de passe. Vous aurez, après l'installation, un avertissement \ref{ImgPiloteProprio2} selon lequel le système doit être redémarré\NotePage{En fait, il suffit simplement, dans le cas des \RefGlossaire{Système}{Pilote}{Driver}{drivers} de cartes graphiques, de redémarrer l'interface graphique après vous être déconnecté de votre session par les touches \Touche{Ctrl} + \Touche{Alt} + \Touche{BackSpace}, mais choisissez le redémarrage si vous n'êtes pas sûr de ce que vous faites.}. Ceci effectué, vous aurez accès à un autre panneau d'informations \ref{ImgPiloteProprio3} vous confirmant la bonne prise en charge de votre \RefGlossaire{Système}{Driver}{Pilote}{pilote} \RefGlossaire{Philosophie}{-}{Logiciel Propriétaire}{propriétaire}.
\PiloteProprio
\section{Activer le bureau en 3D}
\label{RefBureau3D}
\subsection{Présentation}
Si vous possédez une carte graphique 3D, l'installation éventuelle  des \RefGlossaire{Système}{Pilote}{Driver}{drivers} \RefGlossaire{Philosophie}{-}{Logiciel Propriétaire}{propriétaires} vous fera bénéficier des derniers effets de bureaux disponibles sous GNU/Linux qui n'ont vraiment rien à envier aux effets Aéro de Vista qualifiés pompeusement de «~Waow$^{TM}$~»\NotePage{Je n'ai pas pu m'en empêcher \ldots{}} !!!\par
...
Par défaut l'installation devrait choisir le \RefGlossaire{Système}{Kernel}{Noyau}{noyau} le plus adapté à votre installation. Cela est à vérifier car il est à noter qu'un \RefGlossaire{Système}{Kernel}{Noyau}{noyau} adapté à votre matériel est vivement conseillé. Notez aussi que si vous avez beaucoup de RAM -- 1 Gio ou plus -- toute votre RAM ne sera pas prise en compte avec le \RefGlossaire{Système}{Kernel}{Noyau}{noyau} 386.\par
...
\subsection{Modification de GRUB}
Pour utilisateurs «~avertis~» seulement !\\
\ImgCentree{11}{corps/chapitre7/img/Grub.png}{Le menu GRUB}{ImgGrubModif}
Ce logiciel visible par l'image \ref{ImgGrubModif} s'occupe de démarrer les différents \RefGlossaire{Système}{OS}{Système d'exploitation}{systèmes d'exploitation} présents sur votre ordinateur. Il vous donne dix secondes pour choisir GNU/Linux ou Windows -- si vous avez une partition Windows -- et prend 3 secondes au démarrage si vous n'avez que GNU/Linux. Il est personnalisable, pour cela il suffit d'éditer son \AddIndex{Système}{Texte brut}{Fichier de configuration}{fichier de configuration} : taper la commande\NotePage{Toujours et encore dans un \RefGlossaire{-}{Console}{Terminal}{terminal} par Applications \FlecheDroite Accessoires \FlecheDroite Terminal ou après avoir fait \Touche{ALT} + \Touche{F2}} : \Commande{gksudo gedit /boot/grub/menu.lst}\NotePage{Si vous vous rappelez ce qui a été indiqué en \ref{RefMdpRoot}, gksudo -- le module graphique de sudo -- indique que l'on prend les droits de l'administrateur afin d'éditer un fichier, ici le fichier menu.lst se trouvant dans \Chemin{/boot/grub/}, d'où la demande de votre mot de passe}.\\
Quelques éléments intéressants sont :
\begin{itemize}
\item default 0 : \RefGlossaire{Système}{OS}{Système d'exploitation}{Système d'exploitation} lancé par défaut -- ici le premier.
\item timeout 10 : Le temps d'attente en secondes avant de lancer le choix par défaut.
\item \#{}hiddenmenu : Cette ligne est commentée\NotePage{Indiqué par la présence du \# en début de ligne}, cette option est donc désactivée. Si vous ne voulez pas voir le menu à chaque démarrage, enlevez le \#. Ensuite, pour afficher GRUB, Il faudra appuyer sur la touche \Touche{Échap}\NotePage{Ou \Touche{Esc}} dans les 3 secondes du démarrage.
...
On peut aussi améliorer la résolution d'écran lors du démarrage -- et corriger un problème d'inaccessibilité aux \RefGlossaire{-}{Terminal}{Console}{consoles} virtuelles sur certaines cartes graphiques avec le \RefGlossaire{Accélération graphique}{Pilote}{Driver}{driver} nVIDIA -- en ajoutant vga=791 au bout de la ligne : \Code{\# defoptions=quiet splash} qui ainsi deviendra :\\
\Code{\# defoptions=quiet splash vga=791}
Il faut ensuite entrer la commande\NotePage{Dans un \RefGlossaire{-}{Console}{Terminal}{terminal} par Applications \FlecheDroite Accessoires \FlecheDroite Terminal ou après avoir appuyé sur \Touche{ALT} + \Touche{F2}} : \Commande{sudo update-grub} pour que ce paramètre prenne effet.\\ Pour ajuster au mieux ce paramètre, référez-vous au tableau suivant :\par
