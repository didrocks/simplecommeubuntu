...
Pour le désinstaller, il suffit de taper la commande -- dans cet exemple -- \Commande{sudo rm -r  /opt/maniadrive}.
\begin{nota}
...
\item Pour l'installer : \Commande{sudo apt-get install gimp}{\par}
...
\begin{itemize}
\begingroup
\ImgPar{r}{3}{corps/chapitre8/img/Simple_Scan.png}
...
\item Pour l'installer : \Commande{installé par défaut}{\par}
\item Pour le lancer : \Commande{simple-scan}{\par}
...
\item Pour l'installer : \Commande{sudo apt-get install f-spot}{\par}
...
\begin{itemize}
\begingroup
\ImgPar{r}{3}{corps/chapitre8/img/Shotwell.png}
...
\item Équivalent Windows : Lecteur d'image Windows{\par}
\item Pour l'installer : \Commande{installé par défaut}{\par}
\item Pour le lancer : \Commande{shotwell}{\par}
...
\begin{itemize}
\begingroup
\ImgPar{r}{3}{corps/chapitre8/img/Pitivi.png}
...
\item Équivalent Windows : Windows Movie Maker{\par}
\item Pour l'installer : \Commande{Déjà installé par défaut}{\par}
\item Pour le lancer : \Commande{pitivi}{\par}
