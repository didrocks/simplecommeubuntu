...
\item Description : Dictionnaire/traducteur, ce logiciel est très intéressant car il contient un plug-in pouvant vous traduire les termes de n'importe quelle langue ou vous donner la définition par un simple double-clic.{\par}
%%%\item Équivalent Windows : Sleepy{\par}
\item Pour l'installer : \Commande{sudo apt-get install stardict}{\par}
\item Pour le lancer : \Commande{stardict}{\par}
\item Post-installation :{\par}
\begin{itemize}
\item Installez les dictionnaires «~classiques~» et les dictionnaires de traduction des langues désirées en suivant les conseils sur le site officiel.{\par}
\item Dictionnaire fr : \url{http://stardict.sourceforge.net/Dictionaries_fr.php}{\par}
\item Dico de traduction : \url{http://stardict.sourceforge.net/Dictionaries_Quick.php}{\par}
\end{itemize}
