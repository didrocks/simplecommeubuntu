...
\item Description : Vous aimez les RTS mais vous en avez marre des mondes médiévaux, jouez à Globulation 2. Seul ou avec des amis, vous contrôlez des globules, forme de vie plutôt difficile à décrire. Faites-les prospérer\ldots{}{\par}
...
\endgroup
\item Pour l'installer : \Commande{sudo apt-get install childsplay childsplay\IndicCesure{}-alphabet\IndicCesure{}-sounds\IndicCesure{}-fr}{\par}
